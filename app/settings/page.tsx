        ...
        <div className="h-full flex flex-col">
            <div className="mb-6 flex items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-400 mt-2">Configure station-wide preferences like timezone.</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,2fr)_minmax(0,1.5fr)] gap-8 flex-1">
                <form
                ...
                <div className="hidden lg:flex items-center justify-center text-gray-500 border border-dashed border-gray-800 rounded-xl bg-gray-900/40">

                ...
                >
                    ...
                    <div className="absolute top-4 right-4 z-10">
                        <Dialog.Close asChild>
                            <button
                                className="bg-black/50 text-white w-10 h-10 flex items-center justify-center rounded-full hover:bg-black/70 active:scale-95 transition-all backdrop-blur cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
                                aria-label="Close"
                            >
                                <X className="w-5 h-5" />
                            </button>
                        ...
                        <div className="flex-1 overflow-y-auto pb-8 no-scrollbar">
                            ...
                            <div className="px-6 space-y-6">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 text-xs text-gray-500 hover:text-white transition-colors group focus:outline-none focus-visible:text-white"

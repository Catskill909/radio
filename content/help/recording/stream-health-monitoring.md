...
StationDock provides real-time health monitoring for all your configured Icecast streams. This ensures you always know if your audio sources are online and ready for recording or broadcasting.
...
- **<span style="color: #9ca3af">●</span> Disabled:** The stream monitoring is turned off in StationDock.
...
3.  **Check Firewall/Network:** Ensure your StationDock server can reach the Icecast server.
...
> [!TIP]
> If a stream goes offline during a scheduled recording, StationDock will attempt to reconnect, but the recording may contain silence or be split into multiple files.

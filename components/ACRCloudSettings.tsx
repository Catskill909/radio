...
import { Check, Music, Play, Pause, Search, AlertCircle } from 'lucide-react';
    ...
    return (
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 max-w-3xl">
            ...
            {initialSettings.envConfigured && (
                <div className="mt-4 p-3 bg-blue-900/20 border border-blue-800/30 rounded-lg flex items-start gap-2">
                    <AlertCircle className="w-4 h-4 text-blue-400 mt-0.5 flex-shrink-0" />
                    <p className="text-xs text-blue-300">
                        <strong>Production mode:</strong> Environment variables are configured and will override database values.
                    </p>
                </div>
            )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input
                            ...
                            className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-100 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        />
                    </div>
                </div>
            ...
            <div className={`space-y-4 ${!enabled ? 'opacity-50 pointer-events-none' : ''}`}>
                ...
                <div className="flex flex-wrap items-end gap-3">
                    ...
                    <button
                        ...
                        disabled={!testStreamUrl || isIdentifying || !accessKey || !accessSecret}
